...
# Microbiology KPIs
file_path40 = "D:/CPHL-MOH/Support Supervision/2026/May 2025/MB/rrh_MB_tech_capacity.xls"
MBTA  =  pd.read_excel(file_path40)

# Microbiology Details
file_path41 = "D:/CPHL-MOH/Support Supervision/2026/May 2025/MB/MB_details.xls"
MB_Details  =  pd.read_excel(file_path41)


# Gaps RRH
file_path40322 = "D:/CPHL-MOH/Support Supervision/2026/May 2025/MB/rrhMB_gaps.xls"
MBgaps  =  pd.read_excel(file_path40322)

# Microbiology Details
file_path413234 = "D:/CPHL-MOH/Support Supervision/2026/May 2025/MB/rrhMB_tracker.xls"
...
filter_RRH_MB_gaps = filtered_tables["RRH_MB_gaps"]
filter_MB_ActionTracker = filtered_tables["MB_ActionTracker"]
...
st.markdown(
       ...
       <h2 style='font-size: 14px; font-family: sans-serif; font-weight: bold;'>
           Microbiology KPI Status, by RRH
       </h2>
       """, 
       unsafe_allow_html=True
   )
...
gb = GridOptionsBuilder().from_dataframe(filter_RRH_MBTA)
...
# Columns to color
target_cols = ["%age labs with all MB staff trained"
               ]


for col in target_cols:
    if col in filter_RRH_MBTA.columns:
...
gb = GridOptionsBuilder().from_dataframe(filter_MB_Details)
...
for col in target_cols:
    if col in filter_MB_Details.columns:
        gb.configure_column(col, cellStyle=cellstyle_jscode)
...
st.markdown(
       """
       <h2 style='font-size: 14px; font-family: sans-serif; font-weight: bold;'>
           Microbiology Gaps/challenges identified
       </h2>
       """, 
       unsafe_allow_html=True
   )
...
gb = GridOptionsBuilder.from_dataframe(filter_RRH_MB_gaps)
...
for col in filter_RRH_MB_gaps.columns:
...
gb = GridOptionsBuilder.from_dataframe(filter_MB_ActionTracker)
...
# Configure all non-pinned columns
for col in filter_MB_ActionTracker.columns:
